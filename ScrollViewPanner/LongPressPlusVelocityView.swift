//
//  LongPressPlusVelocityView.swift
//  ScrollViewPanner
//
...
class LongPressPlusVelocityView: UIView {
	...
	public var longPressDuration: TimeInterval = 0.5 {
		didSet {
			lpGesture.minimumPressDuration = longPressDuration
		}
	}

	public var numSamples: Int = 2

	private var lpGesture: UILongPressGestureRecognizer!
	...
	private func commonInit() -> Void {
		...
		lpGesture = UILongPressGestureRecognizer(target: self, action: #selector(handleLongPress(_:)))
